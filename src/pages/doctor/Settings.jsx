      ...
      <div className="max-w-4xl mx-auto py-8">
        ...
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 mt-1">Manage your clinic preferences</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[24px] shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="p-6 border-b border-gray-100 flex items-center justify-between">
            ...
            <select
              ...
              className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-medical-blue outline-none"
            >
          ...
          <div className="p-6 border-b border-gray-100 flex items-center justify-between">
            ...
            <button 
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${isHighContrast ? 'bg-medical-blue' : 'bg-gray-300'}`}
            >
